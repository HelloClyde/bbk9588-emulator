...
2. 准备自己的 `bbk9588_nand.bin`，或从
   [BBK 9588 NAND v1.1.0 Release](https://github.com/HelloClyde/bbk9588-emulator/releases/tag/nand-v1.1.0)
   下载官方测试镜像。也可以[直接下载 `bbk9588_nand-v1.1.0.zip`](https://github.com/HelloClyde/bbk9588-emulator/releases/download/nand-v1.1.0/bbk9588_nand-v1.1.0.zip)，
...
当前公开镜像见 [BBK 9588 NAND v1.1.0](https://github.com/HelloClyde/bbk9588-emulator/releases/tag/nand-v1.1.0)。
